...
app.get('/create-message', isAuthenticated, (req, res) => {
    res.render('create-message', { errors: [], message_data: {} });
});
app.post('/create-message', isAuthenticated,
    [
        body('title')
            .trim()
...
app.get('/be-member', isNotMember, (req, res) => {
    res.render('be-member', { title: 'Membership', errors: [] });
});
app.post('/be-member', isNotMember,
    [
        body('passcode')
            .trim()
...
app.post('/message/:id/delete', isAdmin,
    async(req, res, next) => {
        try {
